...
var addonScripts = fs.readdirSync('js/addon/');
var jsFiles = [];
 ...
 **************************/
gulp.task("watch", () => {
  gulp.watch(['styles/**/*.css', '*.html'], gulp.series("styles"));
  gulp.watch(`js/core/*.js`, gulp.series("core-scripts"));
  
  jsFiles.forEach(function(script){
    gulp.watch(`js/addon/` + script, gulp.series(script));
  });
